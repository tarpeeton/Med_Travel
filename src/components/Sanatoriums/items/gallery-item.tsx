...
interface ISanatoriumGalleryProps {
  gallereya: ISanityImage[] | null | undefined;
}

const SanathoryGallery: FC<ISanatoriumGalleryProps> = ({ gallereya }) => {
    ...
    <div className='flex flex-col mt-[120px] px-[16px] mdl:px-[20px] 2xl:px-[200px]'>
      <div className='flex flex-row justify-between items-center'>
        <p className='text-[25px] mdl:text-[35px] 2xl:text-[40px] font-raleway font-bold text-titleDark'>
          {locale === 'ru' ? "Наш санаторий" : locale === 'uz' ? "Bizning sanatoriyamiz" : "Our sanatorium"}
        </p>
      ...
      <div className='mt-[20px] relative mdl:mt-[]40px'>
        <Swiper
          ...
          className="mySwiper"
        >
          {gallereya?.map((image, index) => (
            <SwiperSlide key={image._type + index}>
...
export default SanathoryGallery;
