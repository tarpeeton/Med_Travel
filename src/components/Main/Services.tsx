			...
			<div className='flex flex-col'>
				...
				<Slider {...settings} ref={sliderRef}>
					<div className='flex flex-col mt-[25px]'>
						<Image  src='https://ucarecdn.com/fc24f313-aae2-4923-bf26-76021146aa8f/-/preview/710x644/' width={300} height={300} alt='dfsdf'  className='object-cover w-full'/>
                    ...
                    <button className=" w-[60%] mdl:w-[40%] bg-[#1AB2A6] text-white p-[16px] 2xl:w-[20%] rounded-[10px] font-bold">
                      Найти тур
                    </button>
                    <div className="flex flex-row gap-[8px]">
                      <button
                        onClick={handlePrev}
                        className="flex border border-[#E8E8E8] w-[40px] h-[40px]  rounded-full mdl:flex items-center justify-center 2xl:w-[70px] 2xl:h-[70px]"
                      >
                      ...
                      <button
                        onClick={handleNext}
                        className="flex mdl:flex border border-[#E8E8E8] w-[40px] h-[40px] 2xl:w-[70px] 2xl:h-[70px] rounded-full items-center justify-center"
                      >
