    ...
    return (
        <div className='mt-[420px]'>
            ...
            <div className='mt-[25px] mdl:mt-[30px] 2xl:mt-[35px] flex flex-col mdl:flex-row mdl:flex-wrap mdl:justify-between'>
                {
                    HotelData.slice(0, sliceNumber).map((t, index) => (
                        <div key={index} className='mdl:w-[48%] 2xl:w-[32%] cursor-pointer group 2xl:mb-[50px]'>
                            <div className='h-[199px] w-full overflow-hidden rounded-[15px] relative 2xl:h-[307px]'>
                                ...
                                <div className='mt-[-70px] ml-[15px] transition-opacity duration-500 ease-in-out opacity-0 group-hover:opacity-[100] p-[16px] text-center justify-center bg-white z-[999] text-green100 relative w-[200px] rounded-[10px] font-bold hover:group-[]:'>Забронировать</div>
                            </div>
                            <div className='mt-[12px] mdl:mt-[16px] 2xl:mt-[20px]  flex flex-col'>
                                ...
                                <div className='flex flex-row flex-wrap gap-[8px] mt-[16px] mdl:mt-[20px]'>
                                    ...
                                    {serviceSlice < t.service.length && (<button onClick={handleSerServiceNumber} className='bg-[#E8F7F6] rounded-[5px] text-green100 text-[14px] mdl:text-[16px] py-[8px] px-[20px] font-semibold'>
                                        Еще
                                    </button>)}
