...
import Intermed from '@/public/INTERMEDIMAGE.jpg'
            ...
            <div className='flex flex-col relative'>
                ...
                Материнская компания
                    ...
                    <div className='flex flex-col relative mt-[20px] mdl:mt-[30px] 2xl:mt-[40px] Archivments cursor-pointer'>
                        <div className='relative py-[25px] px-[20px] 2xl:w-[45%] mdl:py-[40px] mdl:px-[30px]  border border-borderColor h-[420px] rounded-[20px] 2xl:h-[500px] pb-[90px]'>
                            <div className=''>
                                ...
                                Мы — дочерняя компания Intermed Innovation, крупнейшего медицинского холдинга в Узбекистане крупной лабораторий и с более чем 15-летним опытом на рынке. Intermed предлагает более 1000 видов анализов, работает с более чем 20 врачами в клиниках и имеет более 100 пунктов сдачи анализов.
                                </p>
                        ...
                        <div className='w-full h-full rounded-[20px] mt-[20px] 2xl:w-[54%] 2xl:mt-0 2xl:h-[500px] overflow-hidden'>
                            <Image src={Intermed} alt='Image Intermed' quality={100} width={1000} height={1000} className='object-contain w-full h-full 2xl:object-cover' />
                        </div>
                    </div>

                {/* <div className=' absolute top-[56%]  mdl:top-[45%] slg:top-[40%] right-[16px]  flex gap-[8px] justify-end 2xl:right-auto 2xl:left-[350px] 2xl:bottom-[50px]  2xl:top-auto'>
