			...
			<div className='flex flex-row flex-wrap py-[25px] px-[16px] justify-between border-b border-borderColor mdl:px-[20px] mdl:py-[40px]'>
				<div className='w-[50%] mdl:w-[33%] 2xl:w-[15%]'>
					...
					<div className='flex flex-col mt-[8px] gap-[4px] mdl:gap-[6px]'>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Туры</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Клиники</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Санатории</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Туры</Link>
				...
				<div className='w-[50%] mdl:w-[33%] 2xl:w-[15%]'>
					...
					<div className='flex flex-col mt-[8px] gap-[4px] mdl:gap-[6px]'>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>О компании</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway'>Партнеры</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Партнеры</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Задать вопрос</Link>
						<Link href='/' className='text-[15px] font-medium text-titleDark font-raleway hover:text-[#1AB2A6] duration-300'>Блог</Link>
