...
const Content: FC = () => {
  ...
  return (
    <div className='mt-[310px] mx-[16px] mdl:mx-[20px] 2xl:mx-[200px]'>
      ...
      <div className='flex flex-col mt-[25px] mdl:mt-[35px] w-full 2xl:mt-[50px]  mdl:flex-row mdl:flex-wrap mdl:justify-between'>
        {DataClinick.slice(0, sliceNumber).map((data, index) => {
        ...
        <p className='text-[15px] text-[#7C7C7C] mdl:text-[18px] 2xl:text-[19px] font-semibold font-raleway '>Ничего не найдено. Попробуйте изменить параметры фильтра</p>
      </div>
      {sliceNumber < DataClinick.length && (
