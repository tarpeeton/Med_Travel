export default {
    ...
    fields: [
            ...
            fields: [
              {
                ...
                validation: (Rule: unknown) => (Rule as any).required().error('Заголовок обязателен'),
              },
              {
                name: 'image',
                type: 'image',
                ...
                validation: (Rule: unknown) => (Rule as any),
              },
              {
                name: 'description',
                type: 'object',
                ...
                validation: (Rule: unknown) => (Rule as any).required().error('Описание обязательно'),
              },
            ],
          },
        ],
      },
      {
        ...
        validation: (Rule: unknown) => (Rule as any).required().error('Необходимо выбрать хотя бы одну категорию'),
      },
      {
        name: 'createdAt',
        type: 'datetime',
